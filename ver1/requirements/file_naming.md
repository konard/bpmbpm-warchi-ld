...
Имя файла состоит из префикса и суффикса.
Каждая папка использует единую систему именования файлов с префикса, совпадающим с именем папки:
...
При необходимоти создавай новые типы Суффиксов файлов. Префикс имени файла подбирай по теме (функциональному назначению) модуля.  
### Правила именования
